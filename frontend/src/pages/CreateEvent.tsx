...
import { Button } from "@/components/ui/button";
import { Label } from "@/components/ui/label";
import { Badge } from "@/components/ui/badge"; // Imported Badge for UI
import {
  Select,
  SelectContent,
  SelectItem,
...
interface EventData {
  ...
  division: string;
  status: "upcoming";
  timezone?: string; // 🔥 1. Add timezone to interface
}
...
const CreateEvent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 🔥 2. Add timezone to payload before sending
    const payload = {
      ...formData,
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {/* 🔥 UI Feedback: Show the detected timezone */}
