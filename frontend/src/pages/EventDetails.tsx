  ...
  const renderStatusSection = () => {
    ...
    if (appStatus === "pending") {
      return (
        <Button
          disabled
          className="w-full md:w-auto min-w-[140px] bg-yellow-500 text-black border-yellow-600 opacity-100 cursor-default"
        >
    ...
    if (appStatus === "approved") {
      return (
        <div className="w-full bg-green-100 border border-green-200 rounded-lg p-4 mb-4 flex items-start gap-3 shadow-sm animate-in fade-in slide-in-from-top-2">
          ...
          <div>
            ...
            <p className="text-sm text-green-700 leading-relaxed">
              ...
              matchmakers will be in touch shortly to confirm your bout details.
              Get ready to fight!
            </p>
          </div>
        </div>
    ...
    if (appStatus === "rejected") {
      return (
        <div className="w-full bg-red-50 border border-red-100 rounded-lg p-4 mb-4 flex items-start gap-3 shadow-sm animate-in fade-in slide-in-from-top-2">
          ...
          <div>
            ...
            <p className="text-sm text-red-700 leading-relaxed">
              We appreciate your interest, but unfortunately, we cannot offer
              you a spot on this card at this time. Please keep training and
    ...
    if (event?.status === "upcoming") {
      return (
        <Button
          ...
          className="w-full md:w-auto min-w-[140px] font-bold bg-gradient-gold hover:opacity-90 text-black shadow-lg hover:shadow-xl transition-all"
        >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Join us for {event.title} at {event.location}. The{" "}
                  {event.division || "Open"} division is set to deliver
                  fireworks.
                </p>
